...
<template>
  <login-layout>
    <oxd-text class="orangehrm-login-title" tag="h3">
      {{ $t('auth.login') }}
    </oxd-text>
    ...
    <div class="orangehrm-login-footer">
      <div v-if="showSocialMedia" class="orangehrm-login-footer-sm">
        <a
          href="https://www.linkedin.com/school/pateros-technological-college/"
          target="_blank"
        >
          <oxd-icon type="svg" class="orangehrm-sm-icon" name="linkedinFill" />
        </a>
        <a href="https://www.facebook.com/ptc1993/" target="_blank">
...
import {OxdAlert, OxdIcon} from '@ohrm/oxd';
